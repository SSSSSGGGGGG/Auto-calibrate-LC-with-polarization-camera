...
# call widget one more time
            ...
            tk.Label(root, text="H", font=big_font, fg="white", bg="black").place(x=5, y=5)
            tk.Label(root, text="V", font=big_font, fg="white", bg="black").place(x=canvas_width/2+5, y=canvas_height/2+5)
